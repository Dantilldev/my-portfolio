...
export default function FlipCard({
  ...
  return (
    ...
    >
      ...
      >
        {/* FramSida */}
        <div className="absolute w-full h-full bg-white shadow-lg rounded-3xl flex flex-col items-center justify-center [backface-visibility:hidden] border-2 border-cyan-300">
          <img
